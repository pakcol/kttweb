            ...
            <div class="row align-items-center h-100">
                ...
                <div class="col-lg-6 left-panel">
                    <div class="content-wrapper">
                        <h4 class="welcome-text">Halo, selamat datang <span class="user-name">{{ Auth::user()->name ?? 'User' }}</span>!</h4>
                        <h1 class="main-title">DATABASE</h1>
                        <p class="company-name">PT. Kupang Tour & Travel</p>
                        <button class="btn-input" onclick="window.location.href='{{ url('/input-data') }}'">
                            Input Data
                        </button>
                    </div>
                </div>
